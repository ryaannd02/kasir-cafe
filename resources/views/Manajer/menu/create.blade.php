...
<div class="p-8 max-w-xl mx-auto bg-white rounded-lg shadow-lg">
    <h1 class="text-3xl font-bold mb-6 text-gray-800">Tambah Menu</h1>
    ...
    <form action="{{ route('menu.store') }}" method="POST" class="space-y-6">
        ...
        <div class="flex justify-end space-x-3">
            ...
            <button type="submit"
                    class="bg-indigo-600 text-white px-5 py-2 rounded-lg hover:bg-indigo-400 transition shadow">
                Simpan
            </button>
        </div>
    </form>
